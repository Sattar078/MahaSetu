...
/**
 * MahaSetu Bridge Logo — the Ashoka-pillar-topped bridge icon
 */
export const MahaSetuLogo = ({ size = 120 }) => (
  <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Base road / bridge deck */}
    <rect x="20" y="110" width="160" height="16" rx="8" fill="#0d599f" />
    
    {/* Left pillar */}
    <rect x="40" y="90" width="14" height="40" rx="3" fill="#0d599f" />
    {/* Right pillar */}
    <rect x="146" y="90" width="14" height="40" rx="3" fill="#0d599f" />
    
    {/* Arch cables */}
    <path d="M47 95 Q100 30 153 95" stroke="#e07520" strokeWidth="5" fill="none" strokeLinecap="round" />
    <path d="M47 100 Q100 45 153 100" stroke="#047857" strokeWidth="3" fill="none" strokeLinecap="round" />
    
    {/* Center tower / Ashoka pillar cap */}
    <rect x="93" y="50" width="14" height="60" rx="3" fill="#0d599f" />
    <circle cx="100" cy="46" r="10" fill="#e07520" />
    <circle cx="100" cy="46" r="5" fill="#fff" />
    
    {/* Vertical cables from arch */}
    <line x1="65" y1="78" x2="65" y2="110" stroke="#0d599f" strokeWidth="2" />
    <line x1="80" y1="64" x2="80" y2="110" stroke="#0d599f" strokeWidth="2" />
    <line x1="120" y1="64" x2="120" y2="110" stroke="#0d599f" strokeWidth="2" />
    <line x1="135" y1="78" x2="135" y2="110" stroke="#0d599f" strokeWidth="2" />
    
    {/* Road lane markings */}
    <line x1="35" y1="118" x2="55" y2="118" stroke="#fff" strokeWidth="2" strokeDasharray="4 3" />
    <line x1="70" y1="118" x2="130" y2="118" stroke="#fff" strokeWidth="2" strokeDasharray="4 3" />
    <line x1="145" y1="118" x2="165" y2="118" stroke="#fff" strokeWidth="2" strokeDasharray="4 3" />
    
    {/* Tagline underline */}
    <rect x="60" y="145" width="80" height="3" rx="1.5" fill="#047857" opacity="0.3" />
    
    {/* Small checkmark badge */}
    <circle cx="155" cy="80" r="12" fill="#047857" />
    <path d="M149 80 L153 84 L161 76" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
  </svg>
);
